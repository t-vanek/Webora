...
namespace D3Parking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921064605_AddReleaseModesAndDeadlines")]
    partial class AddReleaseModesAndDeadlines
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.AvailabilityCampaign", b =>
                {
                    ...
                    b.Property<DateOnly>("CampaignDate")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("Kind", "CampaignDate")
                        .IsUnique();

                    b.HasIndex("Kind", "PeriodStart", "PeriodEnd");
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.Incentives.ParkingContribution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ParkingContributions", (string)null);
                });
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.ParkingSettings", b =>
                {
                    ...
                    b.Property<int>("AvailabilityBusyThresholdPercent")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("HolidayCalendarRegion")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                        .HasDefaultValue("CzechRepublic");
                    ...
                    b.Property<byte[]>("OrientationMap")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("OrientationMapContentType")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<bool>("PublicHolidayReservationsAllowed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<int>("ResidentAlternativeBookingPolicy")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("SameDayReleasesAllowed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("SameDayReservationsAllowed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.ParkingSpotResident", b =>
                {
                    ...
                    b.HasIndex("SpotId", "RemovedAtUtc");

                    b.HasIndex("SpotId", "UserId")
                        .IsUnique();

                    b.ToTable("ParkingSpotResidents", (string)null);
                });
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.QueueEntry", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Status", "StartUtc"), new[] { "EndUtc", "OfferedSpotId", "OfferExpiresAtUtc" });
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.Reservation", b =>
                {
                    ...
                    b.Property<bool>("CountsTowardWeeklyLimit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.Property<Guid?>("SharedByResidentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SharedByResidentId", "Status");

                    b.HasIndex("SpotId", "StartUtc");

                    b.HasIndex("Status", "StartUtc");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Status", "StartUtc"), new[] { "EndUtc", "SpotId", "UserId" });
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.ResidentSpotHandoff", b =>
                {
                    ...
                    b.Property<int?>("MaxCreditsAuthorized")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RecipientId", "Status", "StartUtc");

                    b.HasIndex("ResidentId", "Status", "StartUtc");

                    b.HasIndex("SpotId", "Status", "StartUtc");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("SpotId", "Status", "StartUtc"), new[] { "EndUtc", "ExpiresAtUtc" });

                    b.ToTable("ResidentSpotHandoffs", (string)null);
                });

            modelBuilder.Entity("D3Parking.Domain.Parking.SpotDayAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ResidentId", "Date");

                    b.HasIndex("SpotId", "Date")
                        .IsUnique();

                    b.ToTable("SpotDayAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("D3Parking.Domain.Settings.EntraSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("LinkByVerifiedEmail")
                        .HasColumnType("bit");

                    b.Property<string>("ScimBearerTokenProtected")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("ScimBlockOnDeprovision")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("EntraSettings", (string)null);
                });
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.ResidentSpotHandoff", b =>
                {
                    b.HasOne("D3Parking.Domain.Parking.Reservation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("D3Parking.Domain.Parking.SpotDayAssignment", b =>
                {
                    b.HasOne("D3Parking.Domain.Parking.ParkingSpotResident", null)
                        .WithMany()
